class Time_Conversion {
  Future<List<Map<String, String?>>> convertTime(
    ...
    int next_appointment_time_int =
        next_appointment_time.hour * 60 + next_appointment_time.minute - 10;
    ...
    double average_stay_time_double =
        (next_appointment_time_int - (time_now_int + sum_travel_time)) /
            (travel_time_List.length - 1).truncate();
    ...
    average_stay_time =
        (hour == 0 ? "" : hour.toString().padLeft(2, '0') + "時間") +
