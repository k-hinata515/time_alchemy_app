...
class _Add_destination_Page extends State<Add_destination_Page> {
  ...
  void initState() {
    ...
    Future(() async {
      try {
        ...
        setState(() {
          if (!const MapEquality().equals(_placesResponse, {'検索結果': 'なし'})) {
  ...
  Future<void> _getCurrentLocation() async {
    try {
      ...
      print('現在地を取得 緯度: $_latitude 経度: $_longitude');
    } catch (error) {
      setState(() {
        print(error);
      });
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        Future(() async {
                          ...
                          setState(() {
                            // _placesResponse = _openai_placesResponse;
                            checkboxStates = List<bool>.filled(_placesResponse['places'].length, false); // チェックボックスの状態を初期化
                          });
                        });
                      });
      ...
      GestureDetector(
        ...
        Stack(
          children: [
            ...
            !const MapEquality().equals(_placesResponse, {'検索結果': 'なし'})
            ?Padding(
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child: FittedBox(
                                                  child:
                                                      _placesResponse['places'][index]['photos'] != null
                                                          ? Image.network(
