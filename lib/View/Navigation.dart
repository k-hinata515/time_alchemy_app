...
class _Navigation_Page extends State<Navigation_Page>{
  ...
  final List<Map<String,String?>>  destination=[
    {'label':'大阪駅','arrival_time':'11:45','departure_time':'15:00',},
    {'label':'福島駅','arrival_time':'11:53','departure_time':'11:55',},
    {'label':'西九条駅','arrival_time':'11:58','departure_time':'12:04',},
    {'label':'ユニバーサルシティ駅','arrival_time':'12:09','departure_time':'12:09',},
    {'label':'ユニバーサルスタジオジャパン','arrival_time':'12:16','departure_time':null,},
  ];
  @override
  Widget build(BuildContext context) {
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          SizedBox(width: screen.designW(10),),
                          Text(
                            '${now_time}発',
                            style: TextStyle(
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index){
                        final Map<String, String?> destinationData = destination[index];
                        final String label = destinationData['label'] ?? '';
                        final String? arrivalTime = destinationData['arrival_time'];
                        final String? departureTime = destinationData['departure_time'];
                        return Column(
                          children: [
                            SizedBox(height: screen.designH(120),), 
                            Container(
                              width: double.infinity,
                              height: screen.designH(64),
                              decoration: BoxDecoration(
                                ...
                                children:<Widget> [
                                  ...
                                  ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor: Colors.transparent, // 背景色を透明にする
                                      elevation: 0,
                                      padding: EdgeInsets.zero, // パディングを無効にする
                                      minimumSize: Size(0, 0), // 最小サイズを無効にする
                                    ),
                                    child: Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: [
                                        Text(
                                          ...
                                          style: TextStyle(
                                            color: Colors_compornet.globalBackgroundColorRed,
                                            fontSize: label.length> 8? screen.designW(13):screen.designW(20),
                                            fontWeight: FontWeight.bold,
                                          ),
